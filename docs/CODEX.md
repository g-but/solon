# Codex Best Practices for Solon

This repo is optimized for Codex CLI and agent workflows. Follow these practices for safe, fast collaboration.
...
## Files & Editing
- Use `apply_patch` for all edits. Include only the necessary diffs.
- Avoid large, sweeping changes. Keep patches targeted and incremental.
